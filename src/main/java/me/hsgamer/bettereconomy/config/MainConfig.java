...
public interface MainConfig {
    ...
    @ConfigPath(value = {"commands", "useBalanceTop"}, priority = 1)
    default boolean useBalanceTop() {
        return true;
    }

    @ConfigPath(value = {"commands", "disableOtherCommands"}, priority = 1)
    default boolean disableOtherCommands() {
        return false;
    }
